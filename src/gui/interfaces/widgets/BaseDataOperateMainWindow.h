#ifndef BASEDATAOPERATEMAINWINDOW_H
#define BASEDATAOPERATEMAINWINDOW_H
...
class BaseDataOperateMainWindow : public QMainWindow, public IDataOperateInterface
{
    Q_OBJECT
public:
    explicit BaseDataOperateMainWindow(QWidget *parent = nullptr) : QMainWindow(parent) {}
...
#endif // BASEDATAOPERATEMAINWINDOW_H
