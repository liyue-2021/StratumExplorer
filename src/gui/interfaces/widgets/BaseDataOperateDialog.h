#ifndef BASEDATAOPERATEDIALOG_H
#define BASEDATAOPERATEDIALOG_H
...
class BaseDataOperateDialog : public QDialog, public IDataOperateInterface
{
    Q_OBJECT
public:
    explicit BaseDataOperateDialog(QWidget *parent = nullptr) : QDialog(parent) {}
